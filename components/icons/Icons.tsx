...
export const PromoteIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
...
export const SparklesIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm8 0a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0V6h-1a1 1 0 110-2h1V3a1 1 0 011-1zM9 11a1 1 0 01-2 0V9H6a1 1 0 010-2h1V6a1 1 0 112 0v1h1a1 1 0 110 2H9v2zm8-1a1 1 0 00-1-1h-1V7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 001-1zM9 16a1 1 0 011-1h1v-1a1 1 0 112 0v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0v-1H9a1 1 0 01-1-1z" clipRule="evenodd" />
    </svg>
);
